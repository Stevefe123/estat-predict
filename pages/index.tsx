        ...
        <section className="py-16 bg-gray-900">
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        <h3 className="font-semibold text-xl text-green-400">What does "(Excluded Number of goals - 3+)" mean?</h3>
...
export default function Home() {
    ...
    const LoggedInView = () => {
        ...
        const StatusBanner = () => {
            ...
            if (isTrialActive) { return (<div className="text-center bg-green-900/50 p-3 my-4 max-w-4xl mx-auto rounded-lg"><p className="