...
const LandingPage = ({ onGetStartedClick }) => (
    <>
        <section className="text-center py-20 px-4 bg-gray-900">
            ...
            <button onClick={onGetStartedClick} className="bg-green-500 hover:bg-green-600 text-gray-900 font-bold py-3 px-8 rounded-lg text-lg transform hover:scale-105 transition-transform">Get Your 7-Day Free Trial</button>
        </section>
        <section className="py-16 bg-gray-800/50">
            <div className="max-w-4xl mx-auto px-4 text-center">
                <h2 className="text-4xl font-bold mb-4">About Us</h2>
                <p className="text-gray-400 leading-relaxed">At Estat Predict, we believe successful sports betting isn't about luck; it's about information. We built this platform to provide clear, actionable, and statistically-backed predictions focused exclusively on the "Under 2.5 goals" market. We do the heavy lifting so you can make confident decisions.</p>
            </div>
        </section>
