...
// --- NEW: Disclaimer Footer Component ---
...
export default function Home() {
    ...
    // This sub-component decides what a logged-out user sees
    const LoggedOutView = () => (
        <>
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white font-sans">
            ...
            <WhatsAppFooter />
            {/* NEW: Disclaimer is shown only to logged-out users on the landing page */}
